...
export default function NumberSectionsPage() {
  ...
  const handleDelete = async (id:number) => {
    if(!confirm("Delete this number section?"))return;
  ...
  return (<div className="p-6 space-y-6">
    <div className="flex items-center justify-between"><div><h1 className="text-2xl font-bold text-surface-50">Number Section Query</h1><p className="text-surface-400 text-sm mt-1">{numbers.length} number sections</p></div>
    ...
    <DataTable columns={columns} data={numbers} searchKey="e164" loading={loading} emptyMessage="No number sections found" emptyIcon={<Hash className="w-10 h-10 text-surface-600" />} pageSize={20} />
